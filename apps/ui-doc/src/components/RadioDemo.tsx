...
export function RadioBasic() {
  return (
    <RadioGroup defaultValue="apple" class="flex flex-col gap-2">
...
export function RadioSizes() {
  return (
    <div class="flex flex-col gap-6">
      <RadioGroup defaultValue="1" size="sm" class="flex items-center gap-4">
        <Radio value="1">Small 1</Radio>
        <Radio value="2">Small 2</Radio>
      </RadioGroup>
      <RadioGroup defaultValue="1" size="md" class="flex items-center gap-4">
        <Radio value="1">Medium 1</Radio>
        <Radio value="2">Medium 2</Radio>
      </RadioGroup>
      <RadioGroup defaultValue="1" size="lg" class="flex items-center gap-4">
  ...
  return (
    <div class="flex flex-col gap-6">
       <div class="flex flex-col gap-2">
        ...
        <RadioGroup defaultValue="1" disabled class="flex gap-4">
      ...
      <div class="flex flex-col gap-2">
        ...
        <RadioGroup defaultValue="1" class="flex gap-4">
...
export function RadioControlled() {
  ...
  return (
    <div class="flex flex-col gap-4">
      <RadioGroup value={value()} onChange={setValue} class="flex flex-col gap-2">
