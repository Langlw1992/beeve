    ...
    <div class="flex min-h-screen items-center justify-center px-4">
      <div class="w-full max-w-sm space-y-8">
        ...
        <div class="text-center">
          ...
          <p class="mt-2 text-sm text-muted-foreground">选择一种方式继续</p>
        </div>

        {/* 错误提示 */}
        <Show when={error()}>
          <div class="rounded-[var(--radius)] border border-destructive/50 bg-destructive/10 px-4 py-3 text-sm text-destructive">
            {error()}
          </div>
        </Show>
