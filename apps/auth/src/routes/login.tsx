  ...
  return (
    <div class="flex min-h-screen items-center justify-center px-4">
      <div class="w-full max-w-sm">
        ...
        {/* Header */}
        <div class="mb-8">
          <div class="mb-4 flex size-10 items-center justify-center rounded-xl bg-primary text-primary-foreground font-bold">
            B
          </div>
          <h1 class="text-2xl font-bold tracking-tight">Welcome back</h1>
          <p class="mt-1 text-muted-foreground">
            Sign in to your Beeve account
          </p>
        </div>
        ...
        <p class="text-center text-xs text-muted-foreground">
          By continuing, you agree to Beeve's Terms of Service and Privacy
          Policy.
        </p>
      </div>
    </div>
...
function GithubIcon() {
  return (
    <svg class="size-5" viewBox="0 0 24 24" fill="currentColor" role="img" aria-label="GitHub">
...
function AppleIcon() {
  return (
    <svg class="size-5" viewBox="0 0 24 24" fill="currentColor" role="img" aria-label="Apple">
