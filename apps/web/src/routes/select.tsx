      ...
      <ShowcaseSection title="Features" description="选择器的各种功能">
        <div class="flex flex-col gap-4 max-w-md">
          <div class="flex flex-col gap-1">
            <span class="text-xs text-muted-foreground">With Clear</span>
            <Select
              options={fruitOptions}
          ...
          <div class="flex flex-col gap-1">
            <span class="text-xs text-muted-foreground">With Search</span>
            <Select options={fruitOptions} placeholder="Search fruits..." />
          </div>
          <div class="flex flex-col gap-1">
            <span class="text-xs text-muted-foreground">Loading State</span>
