...
function PresencePage() {
  ...
  return (
    <div class="space-y-12">
      ...
      <ShowcaseSection
        title="带动画效果"
        description="配合 CSS 动画实现进入/退出效果"
      >
        <div class="flex flex-col gap-4 w-full max-w-md">
          ...
          <Presence
            ...
            unmountOnExit
          >
            <div class="p-4 bg-primary/10 rounded-md border border-primary/20 transition-all duration-300 data-[state=open]:animate-in data-[state=open]:fade-in data-[state=open]:slide-in-from-top-2 data-[state=closed]:animate-out data-[state=closed]:fade-out data-[state=closed]:slide-out-to-top-2">
              带有淡入淡出和滑动动画的内容
            </div>
          </Presence>
        </div>
      ...
      >
        <div class="flex flex-col gap-4 w-full max-w-md">
          ...
          >
            <div class="p-4 bg-primary/10 rounded-md border border-primary/20 transition-all duration-500 data-[state=open]:animate-in data-[state=open]:fade-in data-[state=closed]:animate-out data-[state=closed]:fade-out">
      ...
      <ShowcaseSection
        title="渲染函数"
        description="通过函数获取 presence 状态"
      >
        <div class="flex flex-col gap-4 w-full max-w-md">
