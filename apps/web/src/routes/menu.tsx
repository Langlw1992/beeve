...
import { Copy, Trash2, Edit, Share2, Mail, MessageCircle, MoreHorizontal } from 'lucide-solid'
...
function MenuPage() {
  ...
  return (
    <div class="space-y-12">
      ...
      {/* Basic Dropdown */}
      <ShowcaseSection title="基础下拉菜单" description="点击触发的下拉菜单">
        <div class="flex items-center gap-4">
          <Dropdown items={basicItems} onClick={setSelectedKey}>
      ...
      {/* Nested Menu */}
      <ShowcaseSection title="嵌套菜单" description="支持多级子菜单">
        <Dropdown items={nestedItems} onClick={setSelectedKey}>
          <Button>文件操作</Button>
        </Dropdown>
      </ShowcaseSection>

      {/* Checkbox Menu */}
      <ShowcaseSection title="复选框菜单" description="菜单项可以是复选框">
        <div class="flex items-center gap-4">
      ...
      {/* Radio Menu */}
      <ShowcaseSection title="单选菜单" description="菜单项可以是单选组">
        <div class="flex items-center gap-4">
      ...
      {/* Context Menu */}
      <ShowcaseSection title="右键菜单" description="右键点击触发的菜单">
        <ContextMenu items={basicItems} onClick={setSelectedKey}>
      ...
      {/* Menu Sizes */}
      <ShowcaseSection title="菜单尺寸" description="支持不同尺寸">
        <div class="flex items-center gap-4">
          <Dropdown items={basicItems} size="sm">
            <Button size="sm" variant="outline">小尺寸</Button>
          </Dropdown>
          <Dropdown items={basicItems} size="md">
            <Button variant="outline">中尺寸</Button>
          </Dropdown>
          <Dropdown items={basicItems} size="lg">
