  ...
  return (
    <div class="space-y-12">
      <div>
        ...
        <p class="text-muted-foreground mt-2">卡片容器组件，用于展示内容块。</p>
      </div>
