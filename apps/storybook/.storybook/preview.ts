...
import { applyThemeToDOM, type BaseColorName, type ThemeColorName } from '@beeve/ui'

import './styles.css'

// 主题色选项
const BASE_COLORS: BaseColorName[] = ['neutral', 'zinc', 'stone', 'gray', 'slate']
const THEME_COLORS: ThemeColorName[] = [
  'blue', 'green', 'pink', 'orange', 'violet', 'red', 'rose',
  'yellow', 'amber', 'cyan', 'emerald', 'fuchsia', 'indigo',
  'lime', 'purple', 'sky', 'teal',
]
