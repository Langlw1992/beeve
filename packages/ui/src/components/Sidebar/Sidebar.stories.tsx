    ...
    <>
      <Sidebar>
        <Sidebar.Header>
          <Show
            when={open()}
            fallback={<span class="text-lg font-bold text-primary">B</span>}
          >
      ...
      <main class="flex-1 p-8 bg-background overflow-auto">
        ...
        <div class="space-y-2 text-muted-foreground">
          <p>
            当前选中:{' '}
            <span class="text-foreground font-medium">{activeKey()}</span>
          </p>
          <p>
            侧边栏状态:{' '}
            <span class="text-foreground font-medium">{state()}</span>
          </p>
          <p>
            折叠模式:{' '}
            <span class="text-foreground font-medium">{collapsible()}</span>
          </p>
        </div>
